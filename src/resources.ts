// MCP Resource Handlers for the Abnormal Security MCP Server
...
// Node HTTP, and fs-less runtimes.
  ...
  return [
    {
      ...
      name: "Abnormal Security Threat Card",
      description:
        "Interactive MCP Apps card rendering an Abnormal Security threat (read-only)",
